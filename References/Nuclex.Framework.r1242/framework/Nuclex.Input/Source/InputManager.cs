...
#else
using XnaEventHandler = System.EventHandler;
#endif
...
namespace Nuclex.Input {
  ...
  public class InputManager :
...
#if !(XBOX360 || WINDOWS_PHONE)
      if (this.windowMessageInterceptor != null) {
        this.windowMessageInterceptor.Dispose();
        this.windowMessageInterceptor = null;
      }
#endif
    }
...
#else
      // Add main PC mouse
      mice.Add(new WindowMessageMouse(this.windowMessageInterceptor));
#endif
    ...
    private void setupKeyboards() {
      ...
      keyboards.Add(new WindowMessageKeyboard(this.windowMessageInterceptor));
#endif
    ...
    private WindowMessageInterceptor windowMessageInterceptor;
#endif
